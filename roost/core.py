        ...
        try:
            for epoch in range(start_epoch, start_epoch + epochs):
                ...
                if checkpoint:
                    ...
                    save_checkpoint(checkpoint_dict, True, model_name, run_id)
...
def save_checkpoint(state, is_best, model_name, run_id):
    ...
    """
    checkpoint = f"models/roost/{model_name}/checkpoint-r{run_id}.pth.tar"
    best = f"models/roost/{model_name}/best-r{run_id}.pth.tar"

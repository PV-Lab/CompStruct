...
class Model():
    ...
    def fit(self, epochs=None, checkin=None, losscurve=False):
        ...
        for epoch in range(epochs):
            ...
            if (epoch == epochs-1 or
                ...
                os.makedirs('logs/crabnet', exist_ok=True)
                ...
                df_loss.to_csv(f'logs/crabnet/{self.model_name}.csv',
                               index=False)
                ...
                plt.ylabel('MAE')
                plt.legend()
                plt.savefig(f'logs/crabnet/{self.model_name}.png')
    ...
    def save_network(self, model_name=None):
        if model_name is None:
            ...
            path = f'models/crabnet/{model_name}.pth'

...
def results_multitask(  # noqa: C901
    ...
    for j in range(ensemble_folds):
        ...
        if ensemble_folds == 1:
            resume = f"models/roost/{model_name}/{eval_type}-r{run_id}.pth.tar"
            print("Evaluating Model")
        else:
            resume = f"models/roost/{model_name}/{eval_type}-r{j}.pth.tar"
...
def save_results_dict(ids, results_dict, model_name, csv_path):

...
def plot_prop(ax, data_segregation, prop):
    ...
    if data_segregation == 'stable' and prop == 'formation_energy_per_atom':
        ...
        ax.text(-1.15, 0.08, 'Comp', fontweight='bold', color=color[1], fontsize=font['size']-2)
        ax.text(0.1, 0.08, 'Comp', fontweight='bold', color=color[3], fontsize=font['size']-2)
        ax.text(0.7, 0.096, '+', fontweight='bold', color=color[3], fontsize=font['size']-2)
        ax.text(0.1, 0.115, 'Struct', fontweight='bold', color=color[3], fontsize=font['size']-2)
